  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        >
          Fix in 21 days what years couldn't.{' '}
          <span className="text-foreground font-semibold">Daily steps</span> +{' '}
          <span className="text-foreground font-semibold">expert answers</span> ={' '}
