  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 pt-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        >
          <span className="text-foreground font-semibold">Every expert contradicts the last.</span>{' '}
          Cut through the noise—get exact daily steps for 21 days plus instant answers.
        </motion.p>
